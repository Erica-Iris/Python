...
# 机器人主人
bot_master_name = 'Ediath'  # 使用备注名更安全，只允许一个，可远程控制机器人，如果不设置(空)则将文件助手设置为管理员，但不具备远程控制功能

# 监听某些好友群聊，如老板
is_listen_friend = True
listen_friend_names = '梧桐'  # 需要监听的人名称，使用备注名更安全，允许多个用|分隔，如：主管|项目经理|产品狗
listen_friend_groups = '非凡20'  # 在这些群里监听好友说的话，匹配模式：包含“唯一集团工作群”的群


# 转发信息至群
is_forward_mode = False  # 打开转发模式，主人发送给机器人的消息都将转发至forward_groups群
forward_groups = '12班'  # 需要将消息转发的群，匹配模式同上

# 群分享监控
is_listen_sharing = True
listen_sharing_groups = '非凡20'  # 监控群分享，匹配模式同上
